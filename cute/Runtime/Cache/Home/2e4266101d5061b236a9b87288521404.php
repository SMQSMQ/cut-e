...
<script src="http://www.cuteyep.com/app/public/js/jquery-1.11.3.min.js"></script>
	...
	<style type="text/css">
          ...
          .searchbox-top-tt{ padding-left: 30px; height:30px;line-height: 30px;box-sizing: border-box;font-family: microsoft yahei; outline: none; border-radius: 360px; border: 1px solid #ccc; width:100%; margin-top: 6px;}
          .searchbox-top-ico{ height: 30px;line-height: 26px;position: absolute;top: 7px;bottom: 0;left:5px; color: #999;text-align: center; }
				...
				<section id="tabs-search" style="display: none;">
					<div id="list">
						...
						<article class="tabs-con-itm">
							<div style=" padding: 10px;">
								<?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hm-cn-list" onclick="myInterfaceName.see('http://www.cuteyep.com/app/index.php?s=Index/greeting_card_con/id/<?php echo ($vo["id"]); ?>')">
						...
						<article class="tabs-con-itm">
							<div style=" padding: 10px;">
								<?php if(is_array($list1)): $i = 0; $__LIST__ = $list1;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hm-cn-list" onclick="myInterfaceName.see('http://www.cuteyep.com/app/index.php?s=Index/wallpaper_con/id/<?php echo ($vo["id"]); ?>')">
										<div><img src="<?php echo ($vo["cover"]); ?>" class="hm-cn-listi"></div>
										<div class="hm-cn-listx">
											<p><?php echo ($vo["title"]); ?></p>
										</div>
