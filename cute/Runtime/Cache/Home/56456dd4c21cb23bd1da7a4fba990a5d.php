...
.font-flash{
  font-size: 16px; line-height: 28px; height:auto;width: 100%; padding: 0 20px; box-sizing: border-box;
  color: #000; text-align: center; position:absolute;top: 80px; left: 0px;-webkit-text-stroke:1px #fff;
  font-weight: 800;text-shadow: 1px 3px 3px rgba(255,255,255,.5);-webkit-text-shadow: 1px 3px 3px rgba(255,255,255,.5);}
...
.view-wztp{background:#f5f5f5;color: #000;padding: 20px 0; height: 160px; text-indent: 20px; border-radius:5px; border: none; width:100%; margin-bottom: 10px; font-size: 16px; }
...
<div class="mask" style="display:none;"><div class="tijiao">正在提交...</div></div>
       ...
       <div style=" position: fixed;left:0px; top: 0px; width:100%; height: 100%; z-index: 2">
                  <div class="gcd-view">
                       <!--位置-->
                       <div class="gcd-viewpos" style="background:none;bottom:5px;">
                            <ul>
          ...
          <!--文字滚动-->
          <div style="height: 60px; position:fixed; bottom: 80px; width:100%;left:0px; z-index: 2; overflow: hidden;-webkit-mask-image:url(http://www.cuteyep.com/app/public/images/kst.png); ">
                 <div class="font-flash" id="viewNR" style="color:#000;"><?php echo isset($_SESSION["cuty_hk"]["con"])?$_SESSION["cuty_hk"]["con"]:$see["memo"]; ?></div>
          </div>
          <!--编辑文字浮动模块-->
          <div class="view-wz">
