      ...
      .swiper-container img{
        width: 320px;
          ...
          <div class="wplcn-t" style="width:100%;">
            <!--开始-->
            <div class="swiper-container" onclick="disp_page.auto_see('http://www.cuteyep.com/app/index.php?s=Index/wallpaper_con_view/id/<?php echo ($see["id"]); ?>/type/1')">
            ...
            <div class="wplcn-fd">
              ...
              <div class="wplcn-fdic" style="width: 33.33%" onclick="disp_page.share_Text('Cute-壁纸-<?php echo ($see["title"]); ?>','<?php echo ($see["memo"]); ?>http://www.cuteyep.com/h5/index.php?s=Index/wallpaper_con/id/<?php echo ($see["id"]); ?>/type/1')">
          ...
          <div class="wplcn-bg">
            <span class="wplcn-share" onclick="find('Cute-壁纸-<?php echo ($see["title"]); ?>','<?php echo ($con); ?>','<?php echo ($see["cover"]); ?>','http://www.cuteyep.com/h5/index.php?s=Index/wallpaper_con/id/<?php echo ($see["id"]); ?>/type/1')"><img src="/cute/public/images/weixin.svg" style="height:45px; display:block;"></span>
            <span class="wplcn-share" onclick="qq('Cute-壁纸-<?php echo ($see["title"]); ?>','<?php echo ($con); ?>','<?php echo ($see["cover"]); ?>','http://www.cuteyep.com/h5/index.php?s=Index/wallpaper_con/id/<?php echo ($see["id"]); ?>/type/1')"><img src="/cute/public/images/qq.svg" style="height:45px; display:block;"></span>
          ...
          <div class="expzan">
            ...
            <div class="expzan-im">
              ...
              <i class=" expzan-mor" onclick="disp_page('http://www.cuteyep.com/app/index.php?s=Index/like_list/id/<?php echo ($see["id"]); ?>/t/1/type/1')"><?php echo ($count); ?></i>
            </div>
          </div>
          <div class="wplcn-bg1">
            <div class="wplcn-tit">相关分组推荐</div>
            <div class="abum">
              <?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="wp-fllist" onclick="disp_page('http://www.cuteyep.com/app/index.php?s=Index/wallpaper_list/id/<?php echo ($vo["id"]); ?>/type/1')">
          ...
          <div style=" padding: 0px 10px 10px 10px;" >
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hm-cn-list" style="width:48%;" onclick="disp_page('http://www.cuteyep.com/app/index.php?s=Index/wallpaper_con/id/<?php echo ($vo["id"]); ?>/type/1')">
                <div><img src="<?php echo ($vo["cover"]); ?>" class="hm-cn-listi" style="width:100%"></div>
         ...
         <script type="text/javascript">
             ...
             $('.zan').click(function(){
               ...
               $.post('/cute/index.php?s=Index/ios_is_zan',{id:id,type:1},function(data){
                 //alert(data);
             ...
             $('#follow').click(function(){
               var id = '<?php echo ($see["id"]); ?>';
               var  url = 'http://www.cuteyep.com/cute/index.php?s=Login/index/type/1';
               $.post('/cute/index.php?s=Index/ios_is_guanzhu',{id:id,type:1},function(data){
                 if(data=='') disp_page(url);//如果没登陆，跳转到登录页面
                 else{
                   if(is_gz == 0){
                     $('#follow').find('p').eq(1).html('关注');
            ...
            $('.cancel-btn').click(function(){
             ...
             $('.share-inner li').click(function(){
               ...
               var u = 'http://www.cuteyep.com/h5/index.php?s=Index/wallpaper_con/id/<?php echo ($see["id"]); ?>/type/1';
