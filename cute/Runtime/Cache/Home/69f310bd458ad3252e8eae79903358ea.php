...
.share-inner .cancel-btn{
  ...
  color: #0a9950;
        ...
        <div class="share-shade">
          ...
          <div>
            <div class="wplcn-t" style="background: url(<?php echo ($see["cover"]); ?>) no-repeat 50% 50%; background-size: cover;">
              ...
              <div class="wplcn-fd" style=" z-index: 2;">
                ...
                <div class="wplcn-fdic"  onclick="myInterfaceName.card('http://www.cuteyep.com/app/index.php?s=Diy/greeting_card3_opp/id/<?php echo ($see["id"]); ?>')" >
          ...
          <div class="wplcn-bg">
            <span class="wplcn-share" onclick="myInterfaceName.weixin_fenxiang('http://www.cuteyep.com/h5/index.php?s=Index/greeting_card_con/id/<?php echo ($see["id"]); ?>','<?php echo ($see["title"]); ?>','<?php echo ($con); ?>','<?php echo ($see["cover"]); ?>',0)"><img src="/cute/public/images/weixin.svg" style="height:45px; display:block;"></span>
            <span class="wplcn-share" onclick="myInterfaceName.qq_Share('<?php echo ($see["title"]); ?>','<?php echo ($see["con"]); ?>','http://www.cuteyep.com/h5/index.php?s=Index/greeting_card_con/id/<?php echo ($see["id"]); ?>','<?php echo ($see["cover"]); ?>')"><img src="/cute/public/images/qq.svg" style="height:45px; display:block;"></span>
          ...
          <div class="expzan">
            ...
            <div class="expzan-im">
              ...
              <i class=" expzan-mor" onclick="myInterfaceName.see('http://www.cuteyep.com/app/index.php?s=Index/like_list/id/<?php echo ($see["id"]); ?>/t/2')"><?php echo ($count); ?></i>
            </div>
          </div>

          <div class="wplcn-tit2">相关语音贺卡推荐</div>
          <div style=" padding: 0px 10px 10px 10px;" >
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="hm-cn-list" onclick="myInterfaceName.see('http://www.cuteyep.com/app/index.php?s=Index/greeting_card_con/id/<?php echo ($vo["id"]); ?>')">
          ...
          <script type="text/javascript">
                  ...
                  $('.share-inner li').click(function(){
                    ...
                    var u = 'http://www.cuteyep.com/h5/index.php?s=Index/greeting_card_con/id/<?php echo ($see["id"]); ?>';
